...
<body style="background-color: rgb(209, 243, 255);">
    ...
    <header>
        ...
        <h2>Are you sure you want to delete user <br> <?php echo $getTutorById['first_name'];?>?</h2>
    </header>
    ...
    <section class="form-div">
        ...
        <form action="../core/handleForms.php?tutor_id=<?php echo $_GET['tutor_id']; ?>" method="POST" onsubmit="return confirmDeletion();">
            ...
            <p class="btn">
                <input class="submit-btn" type="submit" value="Delete Tutor" name="deleteTutorBtn">
            </p>
